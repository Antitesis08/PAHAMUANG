        ...
        <div class="min-h-screen bg-gray-50">
            <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-4">
                    ...
                    <!-- Total Penghasilan Masuk (klikable) -->
                    <Link
                        :href="route('konsultan.pendapatan')"
                        class="block rounded-2xl border border-green-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-green-300"
                    >
                        <div
                            class="mb-5 flex h-14 w-14 items-center justify-center rounded-xl bg-green-100"
                        >
                        ...
                        <h2 class="text-4xl font-bold text-gray-900">
                            {{ new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0 }).format(stats.total_pendapatan) }}
                        </h2>

                        <p class="mt-2 text-gray-500">
                            Total Penghasilan Masuk
                        </p>
